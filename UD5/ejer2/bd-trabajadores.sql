...
create table centro (
	...
	cenNombre  char(30) default null,
	cenDireccion  char(30) default null,
...
# Tabla de departamentos
 create table  departamento  (
	...
	depNombre  char(20) default null,   
	depDirector  int not null,
	deptipoDirector  char(1) default null,
	depPresupuesto  decimal(9,2) default null,
	depDepende  int default null comment 'número de departamento del que depende',
	depCentro  int default null comment 'número del centro al que pertenece este departamento',
    depEmpleados smallint unsigned default null comment 'número de empregados que traballan no departamento', 
	primary key (depNumero)
);

insert into  departamento (depNumero,depCentro,depDirector,deptipoDirector,depPresupuesto,depDepende,depNombre)
...
create table  empleado  (
	empNumero  int not null auto_increment,
	empDepartamento  int not null comment 'número de departamento en el que trabaja el empleado',
	empExtension smallint not null comment 'extensión telefónica para el trabajador',
	empFechaNacimiento  date default null,
	empFechaIngreso  date default null comment 'fecha de ingreso en la empresa',
	empSalario  decimal(6,2) default null,
	empComision  decimal(6,2) default null,
	empHijos  smallint default null comment 'número de hijos que tiene el trabajador',
	empNombre  char(20) not null,  
